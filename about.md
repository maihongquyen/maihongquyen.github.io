...
<div class="pixel-window">
  <div class="window-header">
    <span class="window-title">📂 USER_PROFILE.EXE</span>
    <div class="window-controls"><div class="dot red"></div><div class="dot yellow"></div></div>
  </div>
  
  <div class="window-content">
    <img src="/images/hquoc.jpg" class="pixel-avatar" alt="Avatar">
    
    <h2 style="color: #f1c40f !important; margin: 10px 0;">MAI HONG QUYEN</h2>
    
    <p style="background: #000; display: inline-block; padding: 5px 10px; color: #2ecc71;">
      📍 HUNG YEN, VN
    </p>
    
    <p>Player Level: 18 (2007) | 🇰🇷 Future Student</p>
    <p>"Thích Code dạo & Nghe nhạc chill"</p>

    <a href="#" class="pixel-btn btn-red">❤ DONATE: MB 208766</a>
  </div>
</div>

<div class="pixel-window">
  <div class="window-header">
    <span class="window-title">💾 MY_LINKS.EXE</span>
    <div class="window-controls"><div class="dot red"></div><div class="dot yellow"></div></div>
  </div>
